...
function disCorAnsw(){
    ...
    if(qCounter === 1 && isCorrect === false){
        ...
        correctAnswers = newDiv.text("Wrong!" + 'The correct answer is   ' + answers.answers1[1]);
...
function quest1() {
    ...
    // add answers 
    $(".btnContainer").append('<button class="answerVal" value=1>' + answers.answers1[1] + '</button>');
    $(".btnContainer").append('<button class="answerVal" value=0>' + answers.answers1[2] + '</button>');
    $(".btnContainer").append('<button class="answerVal" value=0>' + answers.answers1[3] + '</button>');
}
function quest2() {
    qCounter ++;
    $(".btnContainer").append('<div class="questionInput">' + questions.q2 +'</div>');
    $(".btnContainer").append('<button class="answerVal" value=0>' + answers.answers2[1] + '</button>');
    $(".btnContainer").append('<button class="answerVal" value=0>' + answers.answers2[2] + '</button>');
    $(".btnContainer").append('<button class="answerVal" value=1>' + answers.answers2[3] + '</button>');
}
function quest3() {
    qCounter ++;
    $(".btnContainer").append('<div class="questionInput">' + questions.q3 +'</div>');
    $(".btnContainer").append('<button class="answerVal" value=1>' + answers.answers3[1] + '</button>');
    $(".btnContainer").append('<button class="answerVal" value=0>' + answers.answers3[2] + '</button>');
    $(".btnContainer").append('<button class="answerVal" value=0>' + answers.answers3[3] + '</button>');
}
